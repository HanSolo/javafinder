        ...
        switch(outputType) {
            ...
            case BEAUTIFIED_JSON -> {
                if ("windows" == operatingSystem) {
                    ...
                    return msgBuilder.append(INDENT).append(INDENT).append(CURLY_BRACKET_OPEN).append(NEW_LINE)
                                     .append(INDENT).append(INDENT).append(INDENT).append(Constants.BLUE).append(QUOTES).append(FIELD_VENDOR).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(distribution().getVendor().getUiString()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA_NEW_LINE)
                                     .append(INDENT).append(INDENT).append(INDENT).append(Constants.BLUE).append(QUOTES).append(FIELD_NAME).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(distribution().getUiString()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA_NEW_LINE)
                                     .append(INDENT).append(INDENT).append(INDENT).append(Constants.BLUE).append(QUOTES).append(FIELD_VERSION).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(version()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA_NEW_LINE)
                                     .append(INDENT).append(INDENT).append(INDENT).append(Constants.BLUE).append(QUOTES).append(FIELD_PATH).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(location()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA_NEW_LINE)
                                     .append(INDENT).append(INDENT).append(INDENT).append(Constants.BLUE).append(QUOTES).append(FIELD_BUILD_SCOPE).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(buildScope().getUiString().substring(buildScope.getUiString().lastIndexOf(" ") + 1)).append(Constants.RESET_COLOR).append(QUOTES).append(NEW_LINE)
                                     .append(INDENT).append(INDENT).append(CURLY_BRACKET_CLOSE).toString();
                }
            }
            default  -> {
                if ("windows" == operatingSystem) {
                    ...
                    return msgBuilder.append(CURLY_BRACKET_OPEN)
                                     .append(Constants.BLUE).append(QUOTES).append(FIELD_VENDOR).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(distribution().getVendor().getUiString()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA)
                                     .append(Constants.BLUE).append(QUOTES).append(FIELD_NAME).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(distribution().getUiString()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA)
                                     .append(Constants.BLUE).append(QUOTES).append(FIELD_VERSION).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(version()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA)
                                     .append(Constants.BLUE).append(QUOTES).append(FIELD_PATH).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(location()).append(QUOTES).append(Constants.RESET_COLOR).append(COMMA)
                                     .append(Constants.BLUE).append(QUOTES).append(FIELD_BUILD_SCOPE).append(QUOTES).append(Constants.RESET_COLOR).append(COLON).append(Constants.MAGENTA).append(QUOTES).append(buildScope().getUiString().substring(buildScope.getUiString().lastIndexOf(" ") + 1)).append(Constants.RESET_COLOR).append(QUOTES)
                                     .append(CURLY_BRACKET_CLOSE).toString();
                }
            }
        }
