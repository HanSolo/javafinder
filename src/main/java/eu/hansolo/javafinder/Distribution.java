...
public enum Distribution {
    ...
    GRAALVM_CE("GraalVM CE", "graalvm_ce", Vendor.ORACLE, BuildScope.BUILD_OF_GRAALVM),
    GRAALVM_EE("GraalVM EE", "graalvm_ee", Vendor.ORACLE, BuildScope.BUILD_OF_GRAALVM),
    GRAALVM_COMMUNITY("GraalVM Community", "graalvm_community", Vendor.ORACLE, BuildScope.BUILD_OF_GRAALVM),
    GRAALVM("GraalVM", "graalvm", Vendor.ORACLE, BuildScope.BUILD_OF_GRAALVM),
