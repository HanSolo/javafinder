...
#### Shell
```native-image -cp classes:build/libs/javafinder-17.0.15.jar --initialize-at-build-time=Constants -H:Name=javafinder eu.hansolo.javafinder.Main --no-fallback```
